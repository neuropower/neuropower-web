...
class NeuropowerModel(models.Model):
    ...
    ExcZ = models.FloatField(default=0,blank=True,null=True)
    DoF = models.FloatField(default=0,blank=True,null=True)
    Subj = models.IntegerField()
    alpha = models.FloatField(default=0,blank=True,null=True)
    ...
    Smoothx = models.FloatField(default=0,blank=True,null=True)
    Smoothy = models.FloatField(default=0,blank=True,null=True)
    Smoothz = models.FloatField(default=0,blank=True,null=True)
    Voxx = models.FloatField(default=0,blank=True,null=True)
    Voxy = models.FloatField(default=0,blank=True,null=True)
    Voxz = models.FloatField(default=0,blank=True,null=True)
    data = PickledObjectField(default="")
    err = models.CharField(max_length=1000,default="")
    pi1 = models.FloatField(default=0,blank=True,null=True)
    a = models.FloatField(default=0,blank=True,null=True)
    mu = models.FloatField(default=0,blank=True,null=True)
    sigma = models.FloatField(default=0,blank=True,null=True)
    data = PickledObjectField(default="")
    reqPow = models.FloatField(default=0,blank=True,null=True)
